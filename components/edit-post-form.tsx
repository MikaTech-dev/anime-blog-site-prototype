...
// Mock post data - would be fetched from API
const mockPost = {
  id: "1",
  title: "Top 10 Anime of 2024: A Complete Review",
  content: `# Top 10 Anime of 2024: A Complete Review

This year has been absolutely incredible for anime fans! From epic adventures to heartwarming slice-of-life stories, 2024 has delivered some truly unforgettable series.

## 1. Demon Slayer: Infinity Castle Arc

The animation quality continues to blow our minds...

## 2. Attack on Titan: The Final Chapters

An emotional conclusion to one of the greatest anime series...`,
  excerpt:
  ...
  featuredImage: "/anime-characters-colorful-scene.png",
  status: "published",
  slug: "top-10-anime-2024",
  metaDescription: "Complete review of the top 10 anime series of 2024 with detailed analysis and recommendations.",
}
...
export function EditPostForm({ postId }: EditPostFormProps) {
  ...
  useEffect(() => {
    ...
    setMetaDescription(mockPost.metaDescription)
  }, [postId])
                ...
                <Card className="anime-gradient gaming-border">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="border-2 border-dashed gaming-border rounded-lg p-8 text-center">
                      ...
                      <p className="text-muted-foreground mb-2">Replace featured image</p>
                      <Button variant="outline" className="gaming-border-hover bg-transparent">
                        Choose New File
                      </Button>
                    </div>
